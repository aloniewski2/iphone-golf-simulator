...
**Playable mock:** launch the app to play a five-shot challenge on an original 3D driving range. Choose a club, aim, then pull down and release on the swing pad — or swing the iPhone like a club (**Phone**), or prop it up and let the front camera read your arm swing Wii-style (**Camera**). Ball flight is physically simulated (drag, backspin lift, bounce, roll). Switch to **Hole 1**, a 366-yard par 4 over rolling ground, to play tee to cup with lies, an elevated tee, a raised green that breaks, a game-style putting view with a slope grid, and a scorecard. Includes sound, power-linked haptics, ball flight/bounce/roll, three scoring targets, replay, round results, and saved personal best. Camera access is optional through Settings → Camera lab. See [the testing guide](docs/PLAYABLE_MOCK.md).
