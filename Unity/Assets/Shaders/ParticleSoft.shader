// Soft, alpha-blended particles tinted by their vertex colour: the bounce puffs, the splash and
// the ball's halo in flight. Listed in Always Included Shaders by ProjectSetup.
Shader "GolfArcade/ParticleSoft"
{
