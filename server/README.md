...
| `GET /v1/leaderboard?course=cliffside&limit=20` | Best round per player. A course key is its full round (`cliffside`: holes 7, 12–15; `maplebay`: 16–18); `cliffside-12` or `maplebay-17` is one hole on its own. |
