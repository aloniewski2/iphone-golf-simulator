...
| `GET /v1/leaderboard?course=cliffside&limit=20` | Best round per player. `cliffside` is the full five-hole round; `cliffside-12` is hole 12 on its own (likewise 7, 13, 14, 15). |
